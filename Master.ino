...
프로그램 소스 제작 일시: 2018/03/12~2018/03/18
...
void setup() {
  ...
  /*
    //Use this when CO values are unstable.
    analogWrite(A7, HIGH);
    delay(60000);
    analogWrite(A7, 71.4);
    delay(90000);
...
void loop() {
  ...
  Serial.print("CO: ");
  Serial.print(CO_val_log); // Log with base 10 is most stable. Other examples are using various log bases.
  Serial.print("ppm");
  Serial.print("|");
